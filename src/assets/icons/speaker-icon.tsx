...
export function SpeakerIcon({ width, height, stroke, strokeWidth }: SVGComponentProps) {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <path
        d="M9 22H15C18 22 19 21 19 18V6C19 3 18 2 15 2H9C6 2 5 3 5 6V18C5 21 6 22 9 22Z"
        stroke={stroke}
